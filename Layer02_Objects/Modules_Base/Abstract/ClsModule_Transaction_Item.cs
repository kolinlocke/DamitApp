...
namespace Layer02_Objects.Modules_Base.Abstract
{
    public abstract class ClsModule_Transaction_Item: ClsModule_Transaction
    {
        ...
        protected virtual void Setup(ClsSysCurrentUser pCurrentUser = null, string pTableName = "", string pViewName = "", string pViewName_Item = "")
        {
            base.Setup(pCurrentUser, pTableName, pViewName);
            this.mObj_DocumentItem = new ClsDocumentItem(this.mCurrentUser, pViewName_Item);
        }
